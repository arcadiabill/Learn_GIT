...
#define LOG_REMOVE_CANIDATE
#define LOG_BOX_LINE
#define LOG_UNIQUE
#define LOG_XY_CHAIN
#define LOG_Y_WING
 
//Definition to distinguiesh between Y-wind and XY_Chain when invoking
// paris_find()
#define DEF_Y_WING   0
...
// Sudoku declarations in sudoku_solver.callableextern char grid[9][9][]10];
